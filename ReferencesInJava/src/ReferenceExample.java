...
public class ReferenceExample {
       ...
       {
              final ReferenceQueue<ReferenceExample> queue = new ReferenceQueue<ReferenceExample>();
              PhantomReference<ReferenceExample> ex = new PhantomReference<ReferenceExample>(getRefrence(),(ReferenceQueue<? super ReferenceExample>) queue);
              System.gc();
              queue.remove();
              System.out.println("Phantom reference deleted  after"+ex.get());
       }
